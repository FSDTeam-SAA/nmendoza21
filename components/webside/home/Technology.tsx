        ...
        <div className="relative mx-auto max-w-7xl py-12">
          <div className="relative overflow-hidden px-16">
            ...
            >
              {technologyData.items.map((item, index) => {
                ...
                return (
                  <div
                    key={item.id}
                    className={`relative transition-all duration-700 ease-out cursor-pointer flex-shrink-0
              ${
                isActive
            ...
            `}
                  ...
                  >
                    <div className="w-[320px] h-[420px] rounded-xl overflow-hidden shadow-2xl bg-black relative">
                      <Image
                        src={item.image}
                        alt={item.title}
                        fill
