...
export const innovationPageData: InnovationPageData = {
  ...
  feature: {
    ...
    upcoming: {
      ...
      description:
        "Thomas von Erlach will present Vivtex’s most recent advances in oral peptide delivery and join a panel discussion on the current state of advancing oral peptide therapeuticsThomas von Erlach will present Vivtex’s most recent advances in oral peptide delivery and join a panel discussion on the current state of advancing oral peptide therapeutics.",
      linkLabel: "Read Full Issue",
      date: "3rd Peptide-Based Therapeutics Summit",
      place: "April 28-30, 2026  | Boston, MA",
      link: "/news",
    },
  },
  ...
  latestNews: [
    {
      ...
      shortDescription:
        "Join global summits and symposiums to share findings, network with trends, and internal hub news curated by our experts. peers, and witness groundbreaking scientific reveals.",
      image: "/innovation/co.jpg",
      linkLabel: "View Details",
      link: "/news",    
      date: "January 19, 2026 | San Diego, CA",
      content: [
    ...
    // {
    //   id: "news-2",
    //   titile2: "Control Release Society",
    //   title: "Control Release Society",
    //   description:
    ...
    //   linkLabel: "View Details",
    //   link: "/news",
    //   date: "July 14-18, 2025 | Philadelphia, PA",
    //   content: [
    ...
    // {
    //   id: "news-3",
    //   title: "Peptide-Based Therapeutics Summit",
    //   titile2: "Peptide-Based Therapeutics Summit",
    //   description:
